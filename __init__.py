...
bl_info = {
    "name": "FreeBImport_v01",
    "category": "Import-Export",
    "author": "Yorik van Havre; Stefan Krüger; tankshield",
    "version": (0, 1, 0),
    "blender": (4, 4, 0),
    "location": "File > Import > FreeBImport (.FCStd)",
    "description": "Imports a .FCStd file from FreeCAD (rebranded as FreeBImport_v01)",
    "warning": (
...
class IMPORT_OT_FreeCAD(bpy.types.Operator):
    ...
    bl_idname = "freebimportv01.import_freecad"
